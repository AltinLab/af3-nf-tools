...
An nf-core modules repo for running AF3 on Gemini
...
2. List the available modules:
   ...
   ```bash
   nf-core modules --git-remote https://github.com/tgen/af3.git list remote
   ```
   ...
   INFO     Modules available from https://github.com/tgen/af3.git (main):
...
3. Install the module in your pipeline directory:
   ...
   ```bash
   nf-core modules --git-remote https://github.com/tgen/af3.git install examplemodule
   ```
   ...
   INFO     Use the following statement to include this module:
      ...
      include { EXAMPLEMODULE } from '../modules/tgen/examplemodule/main'
   ```
...
5. Remove the module from the pipeline repository if required:
   ...
   ```bash
   nf-core modules --git-remote https://github.com/tgen/af3.git remove examplemodule
   ```
...
6. Check that a locally installed nf-core module is up-to-date compared to the one hosted in this repo:
   ...
   ```bash
   nf-core modules --git-remote https://github.com/tgen/af3.git lint examplemodule
   ```
   ...
   | \| |       \__, \__/ |  \ |___     \`-._,-`-,
      ...
      │╶─────────────┼─────────────────────────────┼─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╴│
      │ examplemodule       │ modules/tgen/examplemodule/main.nf  │ Unable to connect to container registry, code:  403, url: <https://www.docker.com/tgencc/examplemodule-suite:2.0.9>                                │
      │ examplemodule       │ modules/tgen/examplemodule/main.nf  │ Container versions do not match                                                                                                          │                                                                  │
      │              ╵                             ╵                                                                                                                                          │
      ╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
      ╭───────────────────────╮
